      ...
      <div className="new-container-bottom">
        <div className="new-container-bottom__left">
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group style={{width: '57%'}} as={Col} md="7" className="position-relative mb-4">
            ...
            <Form.Control style={{width: '57%'}}  className="position-relative mb-3"
              type="text"
          ...
          <img className="new-container-bottom__right--img"
              src={
                file
                  ...
                  : category.category_img === undefined ? '' : `http://127.0.0.1:8887//${category.category_img}`
              }
              alt=""
            />
        </div>
