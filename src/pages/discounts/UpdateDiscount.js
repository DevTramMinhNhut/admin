...
function UpdateDiscount() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.checkValidity() === true) {
      event.preventDefault();
      axios
        .put(`http://localhost:3000/discount/${discount_id}`, {
  ...
  return (
    <div className="new-container">
      ...
      <div className="new-container-bottom">
        ...
        <div className="new-container-bottom__right" style={{marginTop: '80px'}}>
          <img
            className="new-container-bottom__right--img"
            src={`http://127.0.0.1:8887//${discountList.product?.images[0]?.image_name}`}
            alt=""
          />
        </div>
      </div>
